            ...
            <div class="card p-4 border-0 shadow-sm"
                ...
                <form action="{{ route('employer.login') }}" method="post">
                    ...
                    <button type="submit" class="btn w-100 py-2"
                        style="background: black; border: none; border-radius: 10px; color: #fff; font-weight: bold; font-size: 16px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
                        Login
                    </button>
                </form>
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('employer.register') }}" class="text-decoration-none"
                        style="color: #7c8bff; font-weight: 500;">New

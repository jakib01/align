...
@section('sociobilityVsReflectiveness')
...
<main id="main" class="main">
  ...
  <section class="section">
    ...
    <form action="{{ url('employer/behavior/SocioblityVsReflectiveness/submit') }}" method="POST">
        @csrf
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      if (localStorage.getItem(currentPage + "_submitted")) {
          ...
          if (nextPage && nextPage !== currentPage) {
              ...
              window.location.href = 'candidate/behaviour/assesment/result'; // fallback
          }
      }

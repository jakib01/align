        ...
        <div class="container-fluid px-3 d-flex align-items-center justify-content-between">
            ...
            <nav class="header-nav ms-auto d-none d-lg-block">
                <ul class="d-flex align-items-center flex-column flex-lg-row">
                    <li class="nav-item"><a class="nav-link text-dark" href="{{route('employer.pricing')}}"> Pricing
                        </a></li>
                    <li class="nav-item"><a class="nav-link text-dark" href="{{route(name: 'employer.help')}}">Help</a>
                    </li>
                    <li class="nav-item"><a class="nav-link text-dark" href="{{ route('employer.demo') }}">Demo</a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="{{route('employer_login_form')}}" style="border-bottom: 1px solid #ddd;">
    ...
    <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="mobileNavbar"
        ...
        <div class="offcanvas-header border-bottom" style="border-color: rgba(255, 255, 255, 0.2);">
            ...
            <div class="d-flex align-items-center">
                <img src="{{ secure_asset('assets/img/logo.png') }}" alt="Logo" class="img-fluid"
        ...
        <div class="offcanvas-body p-0">
            <ul class="navbar-nav p-3">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link d-flex align-items-center gap-2 px-3 py-2" href="{{ route('employer.pricing') }}"
                ...
                <!-- Nav Item: Help -->
                <li class="nav-item mb-2">
                    <a class="nav-link d-flex align-items-center gap-2 px-3 py-2" href="{{ route('employer.help') }}"
                        style="color: black; border-radius: 8px; transition: all 0.3s ease;">
                ...
                <!-- Nav Item: Demo  -->
                <li class="nav-item mb-2">
                    <a class="nav-link d-flex align-items-center gap-2 px-3 py-2" href="{{ route('employer.demo') }}"
                        style="color: black; border-radius: 8px; transition: all 0.3s ease;">
                        <i class="bi bi-laptop" style="color: black;"></i>
                        <span>Demo</span>
                    </a>
                </li>
                <!-- Account Dropdown -->
                    ...
                    <ul class="dropdown-menu shadow-lg border-0 bg-light text-dark" aria-labelledby="accountDropdown"
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2"
                                href="{{ route('employer_login_form') }}"
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2"
                                href="{{route('employer.register')}}" style="color: black; transition: all 0.3s ease;">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-5 d-flex flex-column align-items-center mb-2"
                    ...
                    <a href="{{ route('landing.page') }}" class="d-flex align-items-center mb-2 text-decoration-none">
                        <img src="{{secure_asset('assets/img/logo.png')}}" alt="Align Logo" class="footer-logo"
                ...
                <div class="col-12 col-md-3 mb-2" style="padding-left: 0; padding-right: 0;">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li><a href="{{route(name: 'employer.pricing')}}"
                                class="text-dark text-decoration-none">Pricing</a></li>
                        <li><a href="{{route(name: 'employer.help')}}" class="text-dark text-decoration-none">Help</a>
                        </li>
                    </ul>
                </div>
                <!-- Right Side -->

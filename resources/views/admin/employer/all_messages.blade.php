...
@section('all_messages')
    ...
    <!-- Inbox -->
    <h3 class="page-header page-header-top"><i class="fa fa-envelope"></i> Inbox  </h3>
            ...
            <div class="inbox-messages">
                ...
                <div class="inbox-messages-container">
                    ...
                    <div class="inbox-messages-content-reply">
                        <form action="page_inbox.html" method="post" class="form-horizontal remove-margin" onsubmit="return false;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="page_inbox.html" class="form-horizontal remove-margin" onsubmit="return false;">
                        <div class="form-group">
                            <div class="col-xs-12">
